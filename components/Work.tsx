            ...
            return (
              ...
              >
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", padding: "0 4px" }}>
                  <div>
                    <h3 style={{ margin: 0, fontSize: big ? 28 : 20, fontWeight: 700, letterSpacing: "-0.015em" }}>{w.name}</h3>
                    <span className="mono" style={{ fontSize: 11, color: "var(--ink-mute)", letterSpacing: "0.1em" }}>{w.cat}</span>
                  </div>
                  <span aria-hidden="true" style={{ color: "var(--blue-2)" }}><Arrow size={16} rotate={-45} /></span>
                </div>
              </a>
            );
          })}
